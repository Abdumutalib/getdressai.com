/**
 * Mobile UI strings — same language ids as getdressai/locales.js (merge with English for completeness).
 */
...
const RU: Partial<Record<string, string>> = {
  ...
  exploreTitle: 'Те же разделы, что на сайте.',
...
const UZ: Partial<Record<string, string>> = {
  ...
  homeSubtitle:
    'Libos g‘oyalari, kiyib ko‘rish natijasi va xarid — bitta oqimda, saytdagi bilan bir xil.',
  homeMetricTryOnTitle: 'Kiyib ko‘rish',
  homeMetricTryOnBody: 'Surat yuklab, libosni sinab ko‘ring.',
  homeMetricWardrobeTitle: 'Garderob',
  homeMetricWardrobeBody: 'Saqlangan lylar va uslub eslatmalari.',
  homeSectionPromise: 'Ilova nimani beradi',
  homeCard1Title: 'Kiyish mumkin bo‘lgan AI-lylar',
  ...
  homeStep3: 'Hisobga kiring — qurilmalar o‘rtasida sinxron.',
  ...
  exploreWardrobeBody: 'Kuchli lylar va shaxsiy uslub tarixini saqlang.',
  ...
  exploreNoteBody:
    'Sayt Supabase orqali kiradi — mobil qurilmada ham xuddi shu Supabase loyihasini ulang.',
