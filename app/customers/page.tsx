...
export default async function CustomersPage() {
  ...
  return (
    <AppShell>
      <section>
        <h1 className="text-3xl font-black text-[#3e2d1f]">Мижозлар</h1>
        <p className="mt-2 text-sm text-[#6d5a45]">Клиент карточкаси, қарз ва умумий савдо кўрсаткичлари.</p>
      </section>
      ...
      <section className="mt-6 overflow-x-auto rounded-2xl border border-[#d9cab1] bg-[#fffaf0]">
        ...
        {(customers ?? []).length === 0 && <p className="p-4 text-sm text-[#755f46]">Ҳозирча мижозлар йўқ.</p>}
      </section>
    </AppShell>
  );
}
