...
export const translations = {
  en: {
    ...
    upload: {
      ...
      checkingSavedUpload: "Checking your saved photo...",
      ...
      presets: syncedProductCopy.en.presets
    },
    dashboard: {
      eyebrow: "Dashboard",
      workflowEyebrow: syncedProductCopy.en.workflowEyebrow,
      workflowCopy: syncedProductCopy.en.workflowCopy,
      title: "Your results, credits, and history.",
      quietOverview: "Quiet overview",
      recentResults: "Recent results",
      downloadHd: "HD download is for paid plans",
      creditsUsed: "3 of 28 credits used",
      savedBadge: "saved",
      savedFromPhoto: "Saved from your photo",
      savedFromMannequin: "Saved mannequin look",
      emptySavedLooks: "Your saved looks will appear here after you generate one.",
      historyLoadError: "Could not load saved results.",
      download: "Download",
      history: [
    ...
    login: {
      ...
      signupPendingSimple: "Account created. If login does not open yet, confirm your email once and try again.",
      ...
      pinCopy: "Quick access is ready on this device.",
      pinButton: "Open with PIN",
      pinForgot: "Forgot PIN? Use password",
      pinPasswordFallback: "Enter your password once. Then you can save a new PIN.",
      pinReset: "Save a new 4-digit PIN on this device",
  ...
  ru: {
    ...
    upload: {
      ...
      takePhoto: "Снять на камеру",
      checkingSavedUpload: "Проверяем сохраненное фото...",
      ...
      presets: syncedProductCopy.ru.presets
    },
    dashboard: {
      eyebrow: "Панель",
      workflowEyebrow: syncedProductCopy.ru.workflowEyebrow,
      workflowCopy: syncedProductCopy.ru.workflowCopy,
      ...
      quietOverview: "Краткий обзор",
      savedBadge: "сохранено",
      savedFromPhoto: "Сохранено из вашего фото",
      savedFromMannequin: "Сохраненный образ на манекене",
      emptySavedLooks: "Ваши сохраненные образы появятся здесь после генерации.",
      historyLoadError: "Не удалось загрузить сохраненные результаты.",
      download: "Скачать",
      history: [
    ...
    login: {
      ...
      signupPendingSimple: "Аккаунт создан. Если вход не открылся сразу, один раз подтвердите email и попробуйте снова.",
      ...
      pinCopy: "Быстрый доступ готов на этом устройстве.",
      pinButton: "Открыть по PIN",
      pinForgot: "Забыли PIN? Войти по паролю",
      pinPasswordFallback: "Введите пароль один раз. Потом можно сохранить новый PIN.",
      pinReset: "Сохранить новый 4-значный PIN на этом устройстве",
  ...
  uz: {
    ...
    upload: {
      ...
      takePhoto: "Kamerada olish",
      checkingSavedUpload: "Saqlangan rasm tekshirilmoqda...",
      ...
      presets: syncedProductCopy.uz.presets
    },
    dashboard: {
      eyebrow: "Panel",
      workflowEyebrow: syncedProductCopy.uz.workflowEyebrow,
      workflowCopy: syncedProductCopy.uz.workflowCopy,
      ...
      quietOverview: "Qisqa ko'rinish",
      savedBadge: "saqlangan",
      savedFromPhoto: "Rasmingizdan saqlandi",
      savedFromMannequin: "Saqlangan maneken look",
      emptySavedLooks: "Yangi natija yaratganingizdan keyin saqlangan looklar shu yerda chiqadi.",
      historyLoadError: "Saqlangan natijalarni yuklab bo'lmadi.",
    ...
    login: {
      ...
      signupPendingSimple: "Hisob yaratildi. Agar kirish darrov ochilmasa, emailni bir marta tasdiqlab qayta urinib ko'ring.",
      ...
      pinCopy: "Tez kirish shu qurilmada tayyor.",
      pinButton: "PIN bilan ochish",
      pinForgot: "PIN esdan chiqdimi? Parol bilan kiring",
      pinPasswordFallback: "Bir marta parolni kiriting. Keyin yangi PIN saqlashingiz mumkin.",
      pinReset: "Shu qurilmada yangi 4 xonali PIN saqlash",
  ...
  tr: {
    ...
    upload: {
      ...
      checkingSavedUpload: "Kayıtlı fotoğraf kontrol ediliyor...",
      ...
      presets: syncedProductCopy.tr.presets
    },
    dashboard: {
      eyebrow: "Panel",
      workflowEyebrow: syncedProductCopy.tr.workflowEyebrow,
      workflowCopy: syncedProductCopy.tr.workflowCopy,
      ...
      quietOverview: "Sessiz özet",
      savedBadge: "kayıtlı",
      savedFromPhoto: "Fotoğrafınızdan kaydedildi",
      savedFromMannequin: "Kaydedilen manken görünümü",
      emptySavedLooks: "Yeni bir look oluşturduktan sonra kaydedilen sonuçlar burada görünür.",
      historyLoadError: "Kaydedilen sonuçlar yüklenemedi.",
      download: "İndir",
      history: [
    ...
    login: {
      ...
      copy: "E-posta ve şifrenizi kullanın. Bu cihazda hızlı giriş için PIN de kaydedebilirsiniz.",
      email: "E-posta",
      password: "Şifre",
      button: "Devam et",
      ...
      resetHint: "Sıfırlama bağlantısını e-posta ile göndeririz.",
      emailRequired: "Lütfen e-posta girin.",
      unavailable: "Giriş geçici olarak kullanılamıyor. Supabase ayarlı değil.",
      resetUnavailable: "Şifre sıfırlama geçici olarak kullanılamıyor. Supabase ayarlı değil.",
      genericError: "Bir hata oldu. Lütfen tekrar deneyin.",
      signupSuccess: "Hesap oluşturuldu. Giriş yapıldı.",
      signupSuccessWithPin: "Hesap oluşturuldu. PIN bu cihaza kaydedildi.",
      signupPending: "Hesap oluşturuldu. E-postanızı kontrol edip sonra giriş yapın.",
      signupPendingWithPin: "Hesap oluşturuldu. E-postayı doğruladıktan sonra şifre veya bu cihaz PIN'i ile giriş yapabilirsiniz.",
      signupPendingSimple: "Hesap oluşturuldu. Giriş hemen açılmadıysa, e-postayı bir kez doğrulayıp tekrar deneyin.",
      pinEnable: "Bu cihaza 4 haneli PIN kaydet",
      pinPlaceholder: "4 haneli PIN",
      pinConfirm: "PIN'i doğrula",
      pinInvalid: "PIN 4 rakam olmalıdır.",
      pinMismatch: "PIN kodları eşleşmiyor.",
      pinEyebrow: "Hızlı PIN girişi",
      pinTitle: "PIN ile giriş",
      pinCopy: "Hızlı erişim bu cihazda hazır.",
      pinButton: "PIN ile aç",
      pinForgot: "PIN'i mi unuttunuz? Şifre ile girin",
      pinPasswordFallback: "Şifrenizi bir kez girin. Sonra yeni PIN kaydedebilirsiniz.",
      pinReset: "Bu cihazda yeni 4 haneli PIN kaydet",
      pinRemove: "Kayıtlı girişi temizle",
      pinRemoved: "Kayıtlı giriş bu cihazdan silindi.",
      pinLoginError: "PIN ile giriş başarısız oldu. Lütfen tekrar deneyin.",
      pinExpired: "Kayıtlı PIN girişi süresi doldu. Tekrar giriş yapın.",
      pinSessionMissing: "Önce bu cihazda bir kez şifrenizle giriş yapın, sonra PIN çalışır.",
      pinReady: "PIN girişi bu cihazda hazır.",
      pinNeedsPassword: "PIN girişini açmak için önce bu cihazda bir kez şifre ile giriş yapın."
    },
    resetPassword: {
  ...
  es: {
    ...
    upload: {
      ...
      checkingSavedUpload: "Comprobando tu foto guardada...",
      ...
      presets: syncedProductCopy.es.presets
    },
    dashboard: {
      eyebrow: "Panel",
      workflowEyebrow: syncedProductCopy.es.workflowEyebrow,
      workflowCopy: syncedProductCopy.es.workflowCopy,
      ...
      quietOverview: "Resumen discreto",
      savedBadge: "guardados",
      savedFromPhoto: "Guardado desde tu foto",
      savedFromMannequin: "Look guardado en maniqui",
      emptySavedLooks: "Tus looks guardados apareceran aqui despues de generar uno.",
      historyLoadError: "No se pudieron cargar los resultados guardados.",
      download: "Descargar",
      history: [
    ...
    login: {
      ...
      copy: "Usa tu email y contraseña. También puedes guardar un PIN para entrar rápido en este dispositivo.",
      email: "Email",
      password: "Contraseña",
      button: "Continuar",
      ...
      unavailable: "El acceso no está disponible ahora. Supabase no está configurado.",
      resetUnavailable: "El restablecimiento no está disponible ahora. Supabase no está configurado.",
      genericError: "Algo salió mal. Inténtalo otra vez.",
      signupSuccess: "Cuenta creada. Ya has iniciado sesión.",
      signupSuccessWithPin: "Cuenta creada. El PIN se guardó en este dispositivo.",
      signupPending: "Cuenta creada. Revisa tu email y luego entra.",
      signupPendingWithPin: "Cuenta creada. Después de confirmar tu email podrás entrar con tu contraseña o con el PIN de este dispositivo.",
      signupPendingSimple: "Cuenta creada. Si el acceso no se abrió de inmediato, confirma tu email una vez e inténtalo de nuevo.",
      pinEnable: "Guardar PIN de 4 dígitos en este dispositivo",
      ...
      pinEyebrow: "Acceso rápido con PIN",
      pinTitle: "Entrar con PIN",
      pinCopy: "El acceso rápido está listo en este dispositivo.",
      pinButton: "Abrir con PIN",
      pinForgot: "¿Olvidaste el PIN? Entra con contraseña",
      pinPasswordFallback: "Introduce tu contraseña una vez. Después podrás guardar un nuevo PIN.",
      pinReset: "Guardar nuevo PIN de 4 dígitos en este dispositivo",
      pinRemove: "Borrar acceso guardado",
      pinRemoved: "El acceso guardado se eliminó de este dispositivo.",
      pinLoginError: "No se pudo entrar con PIN. Inténtalo otra vez.",
      pinExpired: "El acceso guardado con PIN expiró. Inicia sesión de nuevo.",
      pinSessionMissing: "Primero entra una vez con tu contraseña en este dispositivo y luego funcionará el PIN.",
      pinReady: "El acceso con PIN está listo en este dispositivo.",
      pinNeedsPassword: "Para activar el acceso con PIN, primero entra una vez con tu contraseña en este dispositivo."
    },
    resetPassword: {
  ...
  fr: {
    ...
    upload: {
      ...
      checkingSavedUpload: "Vérification de votre photo enregistrée...",
      ...
      presets: syncedProductCopy.fr.presets
    },
    dashboard: {
      eyebrow: "Tableau de bord",
      workflowEyebrow: syncedProductCopy.fr.workflowEyebrow,
      workflowCopy: syncedProductCopy.fr.workflowCopy,
      ...
      quietOverview: "Apercu discret",
      savedBadge: "enregistres",
      savedFromPhoto: "Enregistre depuis votre photo",
      savedFromMannequin: "Look mannequin enregistre",
      emptySavedLooks: "Vos looks enregistres apparaitront ici apres une generation.",
      historyLoadError: "Impossible de charger les resultats enregistres.",
    ...
    login: {
      ...
      pinCopy: "L'acc?s rapide est pr?t sur cet appareil.",
      pinButton: "Ouvrir avec le PIN",
      pinRemove: "Effacer l'acc?s enregistr?",
      pinRemoved: "L'acc?s enregistr? a ?t? supprim? de cet appareil.",
  ...
  de: {
    ...
    upload: {
      ...
      checkingSavedUpload: "Gespeichertes Foto wird geprüft...",
      ...
      presets: syncedProductCopy.de.presets
    },
    dashboard: {
      eyebrow: "Dashboard",
      workflowEyebrow: syncedProductCopy.de.workflowEyebrow,
      workflowCopy: syncedProductCopy.de.workflowCopy,
      ...
      quietOverview: "Kompakter Uberblick",
      savedBadge: "gespeichert",
      savedFromPhoto: "Von deinem Foto gespeichert",
      savedFromMannequin: "Gespeicherter Mannequin-Look",
      emptySavedLooks: "Deine gespeicherten Looks erscheinen hier nach der ersten Generierung.",
      historyLoadError: "Gespeicherte Ergebnisse konnten nicht geladen werden.",
    ...
    login: {
      ...
      pinCopy: "Schneller Zugriff ist auf diesem Ger?t bereit.",
      pinButton: "Mit PIN ?ffnen",
      pinRemove: "Gespeicherten Zugang l?schen",
      pinRemoved: "Der gespeicherte Zugang wurde von diesem Ger?t entfernt.",
  ...
  ar: {
    ...
    upload: {
      ...
      checkingSavedUpload: "جارٍ التحقق من صورتك المحفوظة...",
      ...
      presets: syncedProductCopy.ar.presets
    },
    dashboard: {
      eyebrow: "لوحة التحكم",
      workflowEyebrow: syncedProductCopy.ar.workflowEyebrow,
      workflowCopy: syncedProductCopy.ar.workflowCopy,
      ...
      quietOverview: "نظرة سريعة",
      savedBadge: "محفوظ",
      savedFromPhoto: "تم الحفظ من صورتك",
      savedFromMannequin: "لوك مانيكان محفوظ",
      emptySavedLooks: "ستظهر الإطلالات المحفوظة هنا بعد إنشاء أول نتيجة.",
      historyLoadError: "تعذر تحميل النتائج المحفوظة.",
      download: "تنزيل",
      history: [
    ...
    login: {
      ...
      pinCopy: "الدخول السريع جاهز على هذا الجهاز.",
      pinButton: "افتح بالPIN",
      pinRemove: "حذف الدخول المحفوظ",
      pinRemoved: "تم حذف الدخول المحفوظ من هذا الجهاز.",
