...
export const translations = {
  ...
  tr: {
    ...
    dashboard: {
      ...
      quietOverview: "Sessiz ozet",
      savedBadge: "kayitli",
      savedFromPhoto: "Fotografinizdan kaydedildi",
      savedFromMannequin: "Kaydedilen manken gorunumu",
      emptySavedLooks: "Yeni bir look olusturduktan sonra kaydedilen sonuclar burada gorunur.",
      historyLoadError: "Kaydedilen sonuclar yuklenemedi.",
      download: "İndir",
      history: [
    ...
    login: {
      ...
      password: "?ifre",
      button: "Devam et",
      signupButton: "Hesap olu?tur",
      loginTab: "Giri?",
      signupTab: "Kay?t ol",
      forgotPassword: "?ifrenizi mi unuttunuz?",
      ...
      pinCopy: "H?zl? eri?im bu cihazda haz?r.",
      pinButton: "PIN ile a?",
      pinRemove: "Kay?tl? giri?i temizle",
      pinRemoved: "Kay?tl? giri? bu cihazdan silindi.",
  ...
  es: {
    ...
    login: {
      ...
      pinInvalid: "El PIN debe tener 4 d?gitos.",
      pinMismatch: "Los PIN no coinciden.",
      pinEyebrow: "Acceso r?pido con PIN",
      pinTitle: "Entrar con PIN",
      pinCopy: "El acceso r?pido est? listo en este dispositivo.",
      pinButton: "Abrir con PIN",
      pinRemove: "Borrar acceso guardado",
      pinRemoved: "El acceso guardado se elimin? de este dispositivo.",
