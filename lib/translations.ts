...
export const translations = {
  en: {
    ...
    login: {
      ...
      verifyCopy: "Open the confirmation email and tap the link, then come back and sign in.",
  ...
  ru: {
    ...
    login: {
      ...
      verifyCopy: "Откройте письмо с подтверждением, нажмите на ссылку и потом вернитесь для входа.",
  ...
  uz: {
    ...
    login: {
      ...
      verifyTitle: "Emailni tekshiring",
      verifyCopy: "Tasdiqlash xatini oching, havolani bosing, keyin qaytib kirishingiz mumkin.",
